...
speciescomp_plot <- speciescomp_plot +
  ...
  theme(legend.title = element_text(size = 18)) +
  theme(legend.text = element_text(size = 16))
view(speciescomp_plot)

ggsave(here::here("speciescomp_plot.png"), height = 9, width = 14)
...
```{r}
###Biomass
biomasspercenttaxa <- read.csv("~/Desktop/eosc573/biomass-percent.csv", row.names = 1)
biomassvaluesgroup <- read.csv("~/Desktop/eosc573/biomassvalues.csv", row.names = 1)
biomasspercentgroups <- read.csv("~/Desktop/eosc573/biomasspercentgroups.csv", row.names = 1)
...
ggsave(here::here("biomassspecies_plot.png"), height = 9, width = 14)
